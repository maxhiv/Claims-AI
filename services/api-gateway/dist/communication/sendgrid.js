...
export const emailTemplates = {
    confirmation: {
        subject: (data) => `Appointment Confirmed - Claim ${data.claimNumber}`,
        html: (data) => `
      <!DOCTYPE html>
      <html>
      <head>
    ...
    reminder: {
        subject: (data) => `Reminder: Appointment Tomorrow - Claim ${data.claimNumber}`,
        html: (data) => `
      <!DOCTYPE html>
      <html>
      <head>
    ...
    cancellation: {
        subject: (data) => `Appointment Cancelled - Claim ${data.claimNumber}`,
        html: (data) => `
      <!DOCTYPE html>
      <html>
      <head>
...
export async function sendAppointmentEmail(type, emailAddress, data, fromEmail = 'noreply@adjusterscheduler.com') {
