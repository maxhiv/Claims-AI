...
export function registerMicroserviceRoutes(app: FastifyInstance) {
  ...
  app.post('/api/routing/geocode', async (req: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  app.post('/api/routing/optimize', async (req: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  app.post('/api/routing/calculate-route', async (req: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  app.post('/api/cq/verify-address', async (req: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  app.post('/api/cq/suggest-addresses', async (req: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  app.post('/api/scheduler/generate-schedule', async (req: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  app.post('/api/scheduler/available-slots', async (req: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  app.post('/api/scheduler/holidays', async (req: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  app.post('/api/scheduler/timezone', async (req: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  app.get('/api/services/health', async (req: FastifyRequest, reply: FastifyReply) => {
    try {
...
function formatAppointmentEmail(type: string, appointmentData: any) {
